# CVE triage for the SELinux userspace stack (libsepol).
# Status codes follow poky meta/conf/cve-check-map.conf.
CVE_STATUS[CVE-2015-3170] = "cpe-incorrect: affects RHEL selinux-policy package, not libsepol; not shipped in this image"
