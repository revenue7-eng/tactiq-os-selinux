# CVE triage for the SELinux userspace stack (selinux-python).
# Status codes follow poky meta/conf/cve-check-map.conf.
CVE_STATUS[CVE-2015-3170] = "cpe-incorrect: affects RHEL selinux-policy package, not selinux-python; not shipped in this image"
